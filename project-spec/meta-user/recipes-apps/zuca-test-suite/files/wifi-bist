...
ARGS=2
FILE="/etc/wpa_supplicant_dig.conf"
...
wpa_cli -i wlan0 enable_network $NETWORK_ID # enables the new added network
# select the new added network to be used and disable the other ones
